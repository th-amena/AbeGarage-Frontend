...
const UpdateOrderStatus = () => {
   ...
   useEffect(() => {
      const fetchOrderDetails = async () => {
         try {
            // Fetch order details using the order_hash
            ...
            // Map initial service completion statuses
   ...
   useEffect(() => {
      // Check if all services are completed to update the status badge
   ...
   const handleCheckboxChange = (id, value) => {
      // Update the completed_value for the specific service
      ...
      try {
         ...
         await orderService.updateOrderStatus(
            order_hash,
            {
               ...
               order_status: allServicesCompleted ? 1 : 0,
            },
